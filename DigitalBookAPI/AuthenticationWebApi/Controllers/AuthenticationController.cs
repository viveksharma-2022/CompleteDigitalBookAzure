...
namespace AuthenticationWebApi.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        [HttpPost]
        public ActionResult<string> Authentication(ValidateUserCredential userdetail)
        {
            try
            {
        ...
        private RequestedUserInfo ValidateUserCredentials(ValidateUserCredential userLogin)
        {
            try
            {
